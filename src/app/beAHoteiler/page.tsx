...
function beAHoteiler() {
  return (
    <div className=' mt-20 bg-neutral-100 absolute inset-0 flex flex-col items-center justify-center px-10'>
      ...
      <p className='p-5 text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita ipsa 
        quasi consectetur deleniti cumque! Laudantium saepe fugit ad labore dolor! Debitis, atque nihil. 
        Animi tempora culpa ex ducimus, laborum repellat?</p>
        
        <Link href='/hotelReg' type="button" className={`${josefinRegular.className} bg-[#7533ac] flex flex-row items-center justify-center text-white mt-10 h-10 mx-auto rounded-full w-2/3 `}>Register your hotel</Link>
