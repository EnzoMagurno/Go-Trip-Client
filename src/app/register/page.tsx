...
const page = () => {
    ...
    useEffect(() => {
        ...
        const phoneSet = [...new Set(optionsPhone)]
        ...
        <>
            <div className='overflow-y-auto'>
                ...
                <div className='flex flex-col pl-5'>
                    ...
                    <p className={`${asap.className}text-base text-gray-500 mt-3 mb-3 pb-2`}>
                ...
                <form className='pl-5 pr-5 flex flex-col'>
                    ...
                    <input className={`${josefin.className} border-2 rounded-xl my-2 pl-3 py-3 pb-3 `} type="text" placeholder='Postal Code' id='postalCodeInput' />

                    <label className={`${josefin.className}`} htmlFor='phone'>Phone number</label>

                    <div>
                        <select className={`${josefin.className} border-2 rounded-xl mr-2 my-2 pl-3 py-3 pb-3 w-1/3`}>
                            {phoneCode.sort().map(phone => (
                                <option key={phone} value={phone}>+{phone}</option>
                            ))}
                        </select>

                        <input className={`${josefin.className} border-2 rounded-xl my-2 pl-3 py-3 pb-3 w-1/2`} type="number" placeholder='Phone Number' id='phone' />
                    </div>

                    <label className={`${josefin.className}`} htmlFor="email">Email adress</label>
                    <input className={`${josefin.className} border-2 rounded-xl my-2 pl-3 py-3 pb-3 `} type="email" placeholder='Email address' id='email' />

                    <label className={`${josefin.className}`} htmlFor="password">Password</label>
                    <input className={`${josefin.className} border-2 rounded-xl my-2 pl-3 py-3 pb-3 `} type="password" placeholder='Create password' id='password' />
                </form>
            </div>
            ...
            <div className='sticky inset-x-0 bottom-0 bg-white border-t-[3px] '>
                ...
                <div className='flex justify-center mt-3 items-center'>
                    ...
                    <svg className='ml-3' width="130" height="1" viewBox="0 0 139 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <line y1="0.5" x2="139" y2="0.5" stroke="black" strokeOpacity="0.35" />
                    </svg>
                </div>
                ...
                <div className='flex justify-center mt-3 items-center'>
                    <button className='text-gray-600 font-semibold py-3 px-3 rounded-full w-[85%] border border-gray-400 border-opacity-100 flex justify-center'>
                        <svg className='mr-2' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="26" height="26"><path fill="#FFC107" d="M43.611,20.083H42V20H24v8h11.303c-1.649,4.657-6.08,8-11.303,8c-6.627,0-12-5.373-12-12c0-6.627,5.373-12,12-12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C12.955,4,4,12.955,4,24c0,11.045,8.955,20,20,20c11.045,0,20-8.955,20-20C44,22.659,43.862,21.35,43.611,20.083z" /><path fill="#FF3D00" d="M6.306,14.691l6.571,4.819C14.655,15.108,18.961,12,24,12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C16.318,4,9.656,8.337,6.306,14.691z" /><path fill="#4CAF50" d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36c-5.202,0-9.619-3.317-11.283-7.946l-6.522,5.025C9.505,39.556,16.227,44,24,44z" /><path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z" /></svg>
                        Sign up with Google
                    </button>
                </div>

                <Link href='' className='flex justify-center mt-5'>
                    <p>Already have an account? <span className='text-[#3F0071]'>Login</span></p>
                </Link>
            </div>
        </>
    )
