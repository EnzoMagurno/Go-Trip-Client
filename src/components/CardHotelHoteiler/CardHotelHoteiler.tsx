	...
	return (
		<Link href={`myHotels/${id}`}>
			<div className='w-full relative m-auto rounded-2xl shadow-img  flex justify-center items-center '>
				...
				<h2
					className={`mt-2 absolute bg-white rounded-full bottom-5   text-center flex justify-center items-center p-2 pr-5 pl-5 text-clip  text-iconsPurple  shadow-img`}
				>
					{name}
				</h2>
			</div>
