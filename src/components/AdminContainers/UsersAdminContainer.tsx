...
import { updatingUsersReal } from '../../redux/Features/UsersReal/usersRealSlice';
...
const UsersAdminContainer = (props) => {
	...
	const Rol = rol[0].toUpperCase() + rol.slice(1, rol.length)
	...
	const [userIsActive, setUserIsActive] = useState('Lock user');
	...
	return (
		<div className=' relative mt-3 mb-3'>
			...
			<form className='relative w-full p-4 pt-7 pb-7 rounded-2xl bg-white shadow-buttonAdd '>
				...
				<div className='grid grid-cols-2 gap-2   bg-red-100 '>
					<div>
				...
				<button
					onClick={updateUser}
					className='w-full mt-5 bg-iconsPurple text-white p-2 rounded-md'
				>
					Save changes
				</button>
			</form>
